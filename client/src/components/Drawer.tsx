...
function Drawer({ isOpen, onClose }:
  ...
  return (
    <div
      className={`fixed z-10 top-0 left-0 h-full w-full md:w-[300px] bg-secondary text-foreground transition-transform duration-300 transform ${isOpen ? 'translate-x-0 ' : 'translate-x-full md:translate-x-[-300px]'
        }`}
    >
      ...
      <div className="w-full h-full">
        ...
        <ul className="flex  flex-col gap-3 items-start pl-10 justify-center w-full  mt-20">
          ...
          <li className="btn-primary text-xl list-item">
            <Link to="/signin" onClick={onClose}>Signin</Link>
          </li>
          <li className="btn-primary text-xl list-item">
